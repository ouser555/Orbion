...
int DT = 5;       // Pin  Detect                           <------------
int CLK = 4;      // Pin  Clockwise                        <------------
int encBut = 8;    //Pin encoder Button                    <------------
...
int vertPin = A3;        // Pin Analog output of Y        <------------
int joyButt = A1;         // Pin Joystick Button           <------------
